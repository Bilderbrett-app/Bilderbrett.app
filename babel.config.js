      ...
      ['module-resolver', {
        alias: {
         ...
         /* 'libp2p': 'libp2p/dist/src',
          ...
          '@libp2p/record': '@libp2p/record/dist/src',
          '@libp2p/utils': '@libp2p/utils/dist/src',
          'get-iterator': 'get-iterator/dist/src',
          '@multiformats/mafmt': '@multiformats/mafmt/dist/src',
          '@multiformats/multiaddr': '@multiformats/multiaddr/dist/src',
          '@multiformats/multiaddr-to-uri': '@multiformats/multiaddr-to-uri/dist/src',
